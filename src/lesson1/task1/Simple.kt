 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (((initial.toDouble() + initial.toDouble() *
        percent.toDouble() / 100) + (initial.toDouble() + initial.toDouble() * percent.toDouble() / 100) *
        percent.toDouble() / 100) + ((initial.toDouble() + initial.toDouble() * percent.toDouble() / 100) +
        (initial.toDouble() + initial.toDouble() * percent.toDouble() / 100) * percent.toDouble() / 100) *
        percent.toDouble() / 100)
...
fun numberRevert(number: Int): Int =
    number / 100 % 10 + (number / 10 % 10) * 10 + (number % 10) * 100
